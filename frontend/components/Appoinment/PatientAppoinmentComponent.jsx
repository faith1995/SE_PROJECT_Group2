        ...
        return (
            <li>
                ...
                <div className="cbp_tmlabel">
                    ...
                    <h4>{this.props.appoinment.type}</h4>
...
class PatientAppoinmentComponent extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(PatientAppoinmentComponent);